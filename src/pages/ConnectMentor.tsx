...
const ConnectMentor = () => {
  ...
  return (
    <main className="container" style={{ maxWidth: 1200, margin: '0 auto', padding: 32, fontFamily: 'Inter, system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif', color: '#333' }}>
      <style>
        {`
