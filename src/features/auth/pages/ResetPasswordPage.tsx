  ...
  return (
    <div className="auth-shell" style={{ fontFamily: 'Inter, system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif' }}>
      <div className="auth-left">
        ...
        <p className="auth-tag">Reset your password to continue your journey.</p>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          {/* Clerk doesn’t have a stable ResetPassword component in all versions; use SignIn with reset link */}
          <SignIn routing="path" path="/auth/reset" afterSignInUrl="/profile-building"/>
          <div className="auth-footer">Use the “Forgot password?” link to receive a reset email.</div>
        </div>
      </div>
    </div>
  );
