...
const MentorProfile = () => {
  ...
  return (
    <main className="container" style={{ maxWidth: 1100, margin: '0 auto', padding: 24, fontFamily: 'Inter, system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif', color: '#333' }}>
      <style>
        {`
